...
-- Property damage: was it pre-existing, or caused by us?
alter table damage_reports add column if not exists damage_origin text;
...
-- Property type & size, pulled from Monday's Install Type / Size columns
